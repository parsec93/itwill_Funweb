 		...
 		$('#noti').click(function(){
 			$.getJSON('main_notice.jsp', function(data){
 				$.each(data,function(index, item){
 					$('table').append("<tr><td class='contxt'><a href='../center/content.jsp?num="+item.num+"&pageNum=1'>"+item.num+"</a></td><td>"+item.subject+"</td><td>"+item.date+"</td>/tr><");
 				});
 			});
 		});
	});
...
<div id="news_notice">
<h3 class="brown"><a href="#" id = "noti">News &amp; Notice</a> &amp;<a href="#" id="driv" >Driver</a></h3>
<table>
<tr><td class="contxt"><a href="#">Vivans.....</a></td><td>2012.11.02</td></tr>
